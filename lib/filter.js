...
const BME_KEYWORDS = [
  ...
  // Tıp + teknoloji kesişimi
  "sağlık teknoloji", "health tech", "healthtech", "health-tech",
  "dijital sağlık", "digital health",
  "sağlık yapay zeka", "health ai", "medical ai",
  "tıpta yapay zeka", "ai in health",
  "teletıp", "telemedicine", "telehealth",
  "e-sağlık", "e-health", "ehealth",
  "akıllı sağlık", "smart health",
  "hastane teknoloji", "hospital technology",
  "klinik veri", "clinical data",
  "tıbbi görüntü", "medical imaging",
  "yapay zeka tıp", "yapay zeka sağlık",
  "ilaç teknoloji", "pharmatech", "pharmaceutical technology",
  "genomik", "genomics",
...
function isWithinSixMonths(event) {
  // Sadece yıl açıkça belirtilmiş tarihleri kabul et
